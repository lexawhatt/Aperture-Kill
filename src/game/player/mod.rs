...
use crate::constants::{
    ...
    AIR_SLIDE_WALL_KICK_Y, CROUCH_SPEED_SCALE, DASH_CHARGE_RECOVERY, DASH_DENY_FLASH_TIME,
    DASH_SPEED, DIVE_BOOST, GRAVITY, GROUND_ACCEL, GROUND_FRICTION, GROUND_SLAM_ACCEL,
    GROUND_SLAM_SPEED, JUMP_VELOCITY, MAX_DASH_CHARGES, MAX_WALL_JUMPS, PLAYER_SIZE, PLAYER_SPEED,
    PORTAL_KICK_SPEED, PORTAL_SLIDE_BOOST, SLAM_BOUNCE_MAX_SPEED, SLAM_BOUNCE_SCALE,
    SLAM_DIVE_MAX_X, SLAM_DIVE_SCALE_X, SLAM_DIVE_SCALE_Y, SLAM_NORMAL_BOUNCE_MAX_SPEED,
    ...
    SLIDE_JUMP_HEIGHT_SCALE, VERTICAL_WALL_JUMP_SPEED, VERTICAL_WALL_JUMP_THRESHOLD, WALL_JUMP_X,
    WALL_JUMP_Y, WALL_SLAM_MAX_SPEED, WALL_SLAM_SCALE, WALL_SLIDE_SPEED,
};
#[cfg(test)]
use crate::platform::input::Input;
use slam::SlamState;
pub use state::{MovementInput, MovementState, PlayerEvent};
use timers::MovementTimers;
...
impl Player {
    ...
    pub fn set_wall_contact_with_speed(&mut self, wall_dir: f32, incoming_speed: f32) {
        ...
        if incoming_speed.abs() >= VERTICAL_WALL_JUMP_THRESHOLD {
            self.timers.start_vertical_wall_jump();
        }
    }
    ...
    pub fn damage(&mut self, amount: f32) -> bool {
        ...
        self.timers.start_damage_grace();
    ...
    fn try_dash_slide(&mut self, input: &MovementInput) -> bool {
        ...
        self.timers.start_dash_storage();
        self.events.push(PlayerEvent::SlideStart);
        true
    }
